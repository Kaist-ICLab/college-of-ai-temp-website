...
export interface NoticeEventRaw {
  id: string;
  deptKey: string; // The translation key for the department name
  titleEn?: string;
  titleKo: string;
  dateEn?: string;
  dateKo?: string;
...
export const rawNoticeEvents: NoticeEventRaw[] = [
      {
    id: "news",
    deptKey: "kaist_ai",
    titleKo: "윤국진 교수 연구팀, 세계 최고 권위 컴퓨터비전 학술대회 ECCV 2026에 논문 13편 채택​",
    bodyKo: [
      "AI대학 윤국진 교수 연구팀이 세계적인 컴퓨터 비전 국제학술대회인 ECCV 2026(European Conference on Computer Vision)에서 총 13편의 논문을 채택시키며, 국제적으로 높은 연구 역량을 다시 한번 입증했다.",
    ...
    posterPath: "/images/notice/eccv2026_pic.jpg",
    posterCaptionKo: "ECCV 2026 (스웨덴 말뫼)",
  },
  {
    id: "2027-spring-aicomputing-grad",
    deptKey: "dept_ai_computing",
    titleEn:
  ...
  },
  {
    ...
    bodyKo: [
      ...
      "특히 이번 행사에서는 'KAIST AI대학 자문단(KAIST College of AI Advisory Board)' 위촉식도 함께 진행됐다. 자문단은 KAIST AI대학의 교육·연구·산업 협력·글로벌 협력·책임 있는 AI 구현 등을 위한 strategic 자문 역할을 맡게 된다.",
      ...
      '이광형 KAIST 총장은 "AI는 이제 특정 분야의 기술을 넘어 과학기술하고 산업, 사회 전반의 변화를 이끄는 핵심 동력이 되고 있다"며, KAIST AI대학이 국가 인재 양성과 연구 혁신을 주도하는 국제 협력 플랫폼으로 발전하도록 지원하겠다고 밝혔다.',
    ...
    bodyEn: [
      ...
      "KAIST President Kwang Hyung Lee remarking that 'AI has now become a key driving force that goes beyond the technology of a specific field to lead change across science and technology, industry, and society as a whole,' and pledged support for the KAIST College of AI to grow into an international cooperation platform that leads national talent cultivation and research innovation.",
