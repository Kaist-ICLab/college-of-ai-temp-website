...
const Navbar: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      path: '/academics',
      subcategories: [
        { name: 'course_info', path: '/course-information' },
        ...
        <div className="flex justify-between h-20 items-center">
          ...
          <Link to="/" className="flex items-center space-x-4" onClick={() => setActiveMenu(null)}>
            ...
            <div className="flex flex-col">
              <span className="text-[#004191] font-bold text-xl tracking-tight leading-none">College of AI</span>
              <span className="text-gray-400 text-[11px] font-medium uppercase tracking-widest">{t('kaist_ai')}</span>
            </div>
          </Link>
