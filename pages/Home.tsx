...
const Home: React.FC = () => {
  ...
  const deptDescriptionsKo = {
    ...
    future: "AI 기술의 사회적 영향과 거버넌스에 초점을 맞춘 학과입니다. AI 기술이 가져올 윤리적 문제, 데이터·알고리즘 윤리, AI 관련 정책·제도, AI 경제학, AI 거버넌스(법·제도) 등을 교육하여, 국가 차원의 AI 전략 수립과 사회·경제 전반의 AI 대전환을 선도할 미래 전략가를 육성합니다. 이는 기술 못지않게 중요한 AI 윤리·정책 전문가를 양성함으로써, AI 확산 과정에서의 사회적 수용성과 지속가능성을 담보하려는 취지입니다."
  };
        ...
        <div className="absolute inset-0 bg-white/0 flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-4 lg:px-4 w-full text-white">
            ...
            <div className="flex space-x-4">
              <Link to="/intro" className="bg-[#0032a0]/85 hover:bg-[#0032a0]/60 px-7 py-3 rounded text-sm font-normal transition-all shadow-lg">
                {t('introduction')}
              </Link>
              <Link to="/admissions" className="bg-white/10 hover:bg-white/20 backdrop-blur-md px-7 py-3 rounded text-sm font-normal border border-white/30 transition-all">
                {t('admissions')}
              </Link>
            </div>
          </div>
            ...
            <div className="md:col-span-4">
              <div className="relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-6 rounded-b-lg">
                  ...
                  <p className="text-white/80 text-sm">{language === 'en' ? 'Dean, College of AI' : 'AI 대학 학장'}</p>
                </div>
              </div>
            </div>
      ...
      <section className="bg-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-6">
            ...
            <Link to="/academics" onClick={() => window.scrollTo(0, 0)} className="group flex items-center text-[#004191] font-bold text-sm uppercase tracking-widest hover:translate-x-1 transition-transform mt-4 md:mt-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-8 text-gray-900">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                 <Link to="/admissions" onClick={() => window.scrollTo(0, 0)} className="bg-[#004191] hover:bg-blue-800 text-white px-10 py-4 rounded-xl font-normal transition-all text-center shadow-lg shadow-[#004191]/20">
                   {t('undergraduate')}
                 </Link>
