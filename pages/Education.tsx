    ...
    <div className="bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          <div className="bg-[#f8faff] border border-blue-100 p-8 rounded-2xl">
             ...
             <button className="text-[#004191] font-bold text-sm hover:underline">Full Requirements &rarr;</button>
          </div>
        ...
        <section className="mb-20">
           <h2 className="text-2xl font-bold mb-8 text-gray-900 border-l-4 border-[#004191] pl-4">{t('graduation_req')} (AI Computing)</h2>
